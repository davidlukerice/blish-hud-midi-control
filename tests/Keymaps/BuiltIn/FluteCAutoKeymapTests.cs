...
{
    [TestFixture]
    public class FluteCAutoKeymapTests
    {
        [Test]
        public void HasCorrectIdAndName()
        {
            var keymap = FluteCAutoKeymap.Instance;

            Assert.That(keymap.Id, Is.EqualTo("flute-c-auto"));
            Assert.That(keymap.Name, Is.EqualTo("Flute (C) (Auto)"));
        }
        ...
        {
            var note = FluteCAutoKeymap.Instance.Notes["C4"];
        ...
        {
            var note = FluteCAutoKeymap.Instance.Notes["C5"];
        ...
        {
            var note = FluteCAutoKeymap.Instance.Notes["C6"];
        ...
        {
            var note = FluteCAutoKeymap.Instance.Notes["C#4"];
        ...
        {
            var note = FluteCAutoKeymap.Instance.Notes["D#4"];
