...
{
    [TestFixture]
    public class HornEAutoKeymapTests
    {
        [Test]
        public void HasCorrectIdAndName()
        {
            var keymap = HornEAutoKeymap.Instance;

            Assert.That(keymap.Id, Is.EqualTo("horn-e-auto"));
            Assert.That(keymap.Name, Is.EqualTo("Horn (E) (Auto)"));
        }
        ...
        {
            var note = HornEAutoKeymap.Instance.Notes["E4"];
        ...
        {
            var note = HornEAutoKeymap.Instance.Notes["E5"];
        ...
        {
            var note = HornEAutoKeymap.Instance.Notes["E6"];
        ...
        {
            var note = HornEAutoKeymap.Instance.Notes["F4"];
        ...
        {
            var note = HornEAutoKeymap.Instance.Notes["G4"];
