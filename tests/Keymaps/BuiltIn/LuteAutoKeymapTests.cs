...
{
    [TestFixture]
    public class LuteAutoKeymapTests
    {
        [Test]
        public void HasCorrectIdAndName()
        {
            var keymap = LuteAutoKeymap.Instance;

            Assert.That(keymap.Id, Is.EqualTo("lute-auto"));
            Assert.That(keymap.Name, Is.EqualTo("Lute (Auto)"));
        }
        ...
        {
            var note = LuteAutoKeymap.Instance.Notes["C3"];
        ...
        {
            var note = LuteAutoKeymap.Instance.Notes["C4"];
        ...
        {
            var note = LuteAutoKeymap.Instance.Notes["C5"];
        ...
        {
            var note = LuteAutoKeymap.Instance.Notes["C6"];
