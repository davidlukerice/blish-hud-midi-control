...
{
    [TestFixture]
    public class HornCAutoKeymapTests
    {
        [Test]
        public void HasCorrectIdAndName()
        {
            var keymap = HornCAutoKeymap.Instance;

            Assert.That(keymap.Id, Is.EqualTo("horn-c-auto"));
            Assert.That(keymap.Name, Is.EqualTo("Horn (C) (Auto)"));
        }
        ...
        {
            var note = HornCAutoKeymap.Instance.Notes["C3"];
        ...
        {
            var note = HornCAutoKeymap.Instance.Notes["C4"];
        ...
        {
            var note = HornCAutoKeymap.Instance.Notes["C5"];
        ...
        {
            var note = HornCAutoKeymap.Instance.Notes["C6"];
